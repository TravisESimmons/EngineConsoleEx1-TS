    ...
    public class Engine
    {
        ...
        public int Weight
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Weight must be greater than 0. Cannot be a negative value.");
                }
        ...
        public int HP
        {
            ...
            private set
            {
                if (value <= 0)
                {
                    throw new ArgumentOutOfRangeException("HP must be greater than 0. Cannot be a negative value.");
                }
        ...
        public override string ToString()
        {
            ...
            return $"{SerialNumber},{Model},{Weight},{HP}";
        }
    }
}
